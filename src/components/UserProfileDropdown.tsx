...
export default function UserProfileDropdown({
  ...
  const handleDailyCheckIn = () => {
    ...
    const updatedUser: UserProfile = {
      ...user,
      loyaltyPoints: (user.loyaltyPoints || 0) + 120,
    };
    ...
    setSuccessMessage("تم تسجيل الحضور اليومي وحصلت على +120 نقطة! / Daily check-in complete! +120 PTS");
                ...
                return (
                  <>
                    ...
                    <div className="flex justify-between items-center pt-1 gap-2">
                      ...
                      >
                        {hasCheckedInToday ? "✓ تم تسجيل اليوم" : "حضور يومي +120 PTS"}
                      </button>
                    </div>
                  </>
                );
        ...
        {activeSubTab === "rewards" && (
          <div className="space-y-4 mt-4">
            ...
            <div className="space-y-2 max-h-56 overflow-y-auto pr-1 scrollbar-thin">
              {rewards.length === 0 ? (
                <div className="text-center py-6 text-brand-outline text-[11px] bg-white border border-[#c5a880]/15 rounded-xl">
                  لا توجد جوائز متاحة حالياً. الرجاء المحاولة لاحقاً.
                  <br />
                  <span className="text-[9px] opacity-75">No rewards available at the moment. Please check back later.</span>
                </div>
              ) : (
                rewards.map((reward) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center pt-1 border-t border-[#c5a880]/5">
                        <span className="text-[8px] text-brand-outline/65 font-mono select-all">
                          Code: {reward.code}
                        </span>
                        <button
